      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center gap-12">
        ...
        >
          {MORE_TESTIMONIALS.map((t) => (
            ...
            >
              <blockquote className="text-[#333333] text-sm leading-relaxed m-0">
                &quot;{t.quote}&quot;
              </blockquote>
              <figcaption className="flex items-center gap-3.5">
                <div className="w-11 h-11 rounded-full bg-[#4F3A96] flex items-center justify-center shrink-0 text-white font-bold text-sm" aria-hidden="true">
                  {t.initials}
                </div>
                <div>
                  <span className="block text-[#1B1730] font-bold text-sm">
                    {t.name}
                  </span>

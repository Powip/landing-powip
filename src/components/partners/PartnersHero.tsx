...
const ORDERS = [
  { id: 'ORD-139938', client: 'Richard Ccama', place: 'San Borja', zone: 'Lima Sur', zoneColor: '#7C3AED', zoneBg: '#F3ECFD', total: 'S/ 115', saldo: 'Saldo S/ 103' },
  { id: 'ORD-139919', client: 'Blanca Osorio', place: 'Lima', zone: 'Lima Centro', zoneColor: '#16A34A', zoneBg: '#E7F7EC', total: 'S/ 99', saldo: null },
  { id: 'ORD-139375', client: 'Maribel Sánchez', place: 'Rímac', zone: 'Provincias', zoneColor: '#6B6880', zoneBg: '#F1F0F4', total: 'S/ 199', saldo: null },
  { id: 'ORD-139363', client: 'Lorena Ramos', place: 'Los Olivos', zone: 'Lima Norte', zoneColor: '#2563EB', zoneBg: '#E7F0FD', total: 'S/ 115', saldo: 'Saldo S/ 85' },
];

export default function PartnersHero({ partner, signupHref }: { partner: PartnerData; signupHref: string }) {
  return (
    <header className="relative w-full overflow-hidden bg-gradient-to-b from-white to-[#F4F1FD] pt-10 pb-16 px-6 md:px-20">
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-start">
          <div className="inline-flex items-center gap-3 bg-white/90 border border-gray-200 rounded-full pl-3 pr-5 py-1.5 shadow-sm font-bold backdrop-blur-sm">
            <span className="text-sm" style={{ color: partner.color }}>{partner.displayName}</span>
            <span className="text-gray-300 font-bold" aria-hidden="true">×</span>
            <span className="flex items-center gap-1.5 text-sm text-[#4F3A96]">
              <PowipMark className="w-4 h-4 text-[#4F3A96]" />
              POWIP
            </span>
          </div>

          <span className="mt-4 inline-flex items-center gap-2 text-[#006B82] font-bold uppercase text-xs tracking-wide bg-[#E0F7FA] border border-[#80DEEA] px-3.5 py-1.5 rounded-full">
            {partner.eyebrow}
          </span>

          <h1 className="mt-4 text-[#4F3A96] font-bold text-4xl md:text-[52px] leading-[1.08] tracking-tight">
            {partner.heroTitle}{' '}
            <span className="bg-[#C5E6E8] px-2 rounded">{partner.heroTitleHighlight}</span>
          </h1>

          <p className="mt-5 text-[#4a4664] text-base md:text-lg max-w-lg leading-relaxed">
            {partner.heroLead}
          </p>
          ...
          <div className="mt-7 flex flex-wrap items-center gap-4">
            ...
            <a
              href="#como"
              className="inline-flex items-center gap-2 bg-white/70 backdrop-blur-sm border border-gray-200 text-[#4F3A96] font-bold text-base px-8 py-4 rounded-2xl"
            >
              Ver cómo funciona
            </a>
          </div>
          ...
          <div className="mt-7 flex items-center gap-4 flex-wrap">
            ...
            <span className="text-[#F5A623] tracking-widest text-base" aria-hidden="true">★★★★★</span>
            <span className="sr-only">Calificación 5 de 5 estrellas</span>
            <span className="text-[#67637E] text-sm"><b className="text-[#1B1730]">+1,200 negocios</b> ya ordenan su operación con POWIP</span>
          </div>
        </div>

        {/* Right column: fake app preview — decorativo, sin datos reales */}
        <div className="relative" aria-hidden="true">
          <div className="hidden lg:flex absolute -top-6 -left-6 z-10 items-center gap-2.5 bg-white rounded-2xl shadow-xl px-4 py-3 font-bold">
            ...
            <span>
              <small className="block text-[11px] text-[#67637E] font-medium">Por cobrar (COD)</small>
          ...
          <img
            ...
            alt=""
            aria-hidden="true"
            className="hidden lg:block absolute -bottom-20 -left-20 xl:-left-24 z-20 w-56 xl:w-64 h-auto drop-shadow-2xl pointer-events-none"
          />
            ...
            <div className="bg-white rounded-3xl overflow-hidden border border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-[130px_1fr]">
                <div className="hidden sm:block bg-[#faf9fe] border-r border-gray-100 p-2.5 text-[11px]">
                  {['Dashboard', 'Comercial', 'Operaciones', 'Productos', 'Finanzas'].map((item) => (
                    <div
                      key={item}
                ...
                <div className="p-3.5 bg-[#fbfbfd]">
                  <div className="flex justify-between items-center mb-2">
                    <div>
                      <h4 className="text-[13px] font-bold text-[#1B1730]">Pedidos de hoy</h4>
                      <p className="text-[9.5px] text-[#67637E]">{partner.appSub}</p>
                    </div>
                  ...
                  <div className="mt-2.5 pt-2 border-t border-gray-100 flex justify-between flex-wrap gap-1 text-[9px] text-[#67637E]">
                    <span><b className="text-[#1E8C86]">7 listos</b> · 0 reprogramados · S/ 367 por cobrar</span>

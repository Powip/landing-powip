    ...
    <footer className="w-full bg-white py-14 md:py-20 px-6 md:px-20 flex flex-col items-center text-center md:items-stretch md:text-left md:flex-row flex-wrap justify-between gap-10 md:gap-12 border-t border-gray-100">
      ...
      <div className="flex flex-col items-center md:items-start gap-6 md:gap-8 w-full md:w-auto">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="text-[#4F3A96] font-bold text-2xl tracking-tight">
            POWIP
          </span>
        </Link>
        ...
        <div className="flex flex-row flex-wrap justify-center md:justify-start gap-x-5 gap-y-2">
          ...
          <Link
            href="https://www.instagram.com/powip.pe?igsi=czcwNmYyeHI4eTQ0&utm_source=qr"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#666666] text-sm hover:text-[#4F3A96] transition-colors"
          >
          ...
          <Link
            href="https://www.linkedin.com/company/powip/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#666666] text-sm hover:text-[#4F3A96] transition-colors"
          >
          ...
          <Link
            href="https://www.tiktok.com/@powip.lat?_r=1&_t=ZS-99DZQxauAaL"
            target="_blank"
            rel="noopener noreferrer"
            className="text-[#666666] text-sm hover:text-[#4F3A96] transition-colors"
          >
      ...
      <div className="flex flex-col items-center md:items-start gap-4 w-full md:w-auto pt-8 md:pt-0 border-t border-gray-100 md:border-0">
        ...
        <Link
          href="/reclamaciones"
          className="text-[#4F3A96] text-sm font-medium hover:underline"
        >
      ...
      <div className="flex flex-col items-center md:items-start gap-4 w-full md:w-auto pt-8 md:pt-0 border-t border-gray-100 md:border-0">
        ...
        <a
          href="mailto:hola@powip.lat"
          className="text-[#666666] text-sm hover:text-[#4F3A96] transition-colors"
        >
          hola@powip.lat
        </a>
        <a
          href="https://wa.me/51923101193"
          target="_blank"
          rel="noreferrer"
          className="text-[#666666] text-sm hover:text-[#4F3A96] transition-colors"
        >
